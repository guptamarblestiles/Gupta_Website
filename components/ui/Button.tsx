...
const baseClasses =
  "inline-flex items-center justify-center gap-2 font-body uppercase tracking-widest transition-colors duration-300 whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:ring-offset-2";
